...
export class Backend implements backendInterface {
    ...
    async createReminder(arg0: string, arg1: Time): Promise<ReminderId> {
        if (this.processError) {
            try {
    ...
    async getPendingReminders(): Promise<Array<Reminder>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingReminders();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReminder(arg0: ReminderId): Promise<Reminder> {
        if (this.processError) {
            try {
    ...
    async markReminderTriggered(arg0: ReminderId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markReminderTriggered(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateReminder(arg0: ReminderId, arg1: string, arg2: Time): Promise<void> {
        if (this.processError) {
            try {
